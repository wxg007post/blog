...
function buildIndex() {
  ...
  fetchJSON(baseURL + "index.json", function (data) {
    var options = {
      ...
      threshold: 0.0,
      includeMatches: true,
      useTokenSearch: true, // project override: token-based search (see plan 3.6)
      keys: [
        { name: "title", weight: 0.8 },
        { name: "section", weight: 0.2 },
        { name: "summary", weight: 0.6 },
        { name: "content", weight: 0.4 },
        { name: "tags", weight: 0.5 },       // project override: search tags
        { name: "categories", weight: 0.3 }, // project override: search categories
      ],
    };
    /*var finalIndex = [];
    for (var i in data) {
